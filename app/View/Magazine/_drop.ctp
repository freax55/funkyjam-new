...
<div id="company-page-section">
    <div class="container"> 
        <div class="col-md-8 col-md-offset-2">
            <div class="row">
            <h1 class="artist-title2">メールマガジン退会</h1>

                <article id="contentArea">
                    <div id="contentBox">
                        <p>退会のお手続きについてメールをお送りいたします。<br />
                        <form action="index.php" method="post">
                            <table class="table" style="margin-bottom: 0px;">
                                <tr>
                                <th style="width: 136px; padding-left: 0px; padding-top: 15px;">メールアドレス</th>
                            ...
                            <input type="submit" value="案内メールを送信する" /></p>
