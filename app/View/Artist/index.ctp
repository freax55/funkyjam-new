...
<?= view::element('part_artist_nav') ?>
           	...
           	<div class="col-lg-3">
				<ul>
					<li><a href="/artist/kubota" class="author"><img src="/img/portfolio/Kubota_m.png" width="70" class="img-circle"><span class="artist_side">Toshinobu Kubota</span></a></li>
					<li><a href="/artist/urashima" class="author"><img src="/img/portfolio/Urashima_m.png" width="70" class="img-circle"><span class="artist_side">Rinko Urashima</span></a></li>
					<li><a href="/artist/mori" class="author"><img src="/img/portfolio/Mori_m.png" width="70" class="img-circle"><span class="artist_side">Daisuke Mori</span></a></li>
					<li><a href="/artist/bes" class="author"><img src="/img/portfolio/BES_m.png" width="70" class="img-circle"><span class="artist_side">Brown Eyed Soul</span></a></li>
				</ul>                
            </div>
        </div>
    </div>
