            ...
            <section>
                <div class="col-sm-6 col-md-3 col-lg-3">
                    <article class="home-news-item">
                        ...
                        <a href="">
                        <img src="img/portfolio/kubota_top.jpg" alt="" class="img-responsive" />   
                ...
                <div class="col-sm-6 col-md-3 col-lg-3">
                    <article class="home-news-item">
                        <span class="bg-red p3-5 white blink blink-left box-shadow">NEW</span>
                        <a href="">
                        <img src="img/portfolio/kubota_top2.jpg" alt="" class="img-responsive" />   
                        <div class="home-news-overlay blk-back">
                ...
                <div class="col-sm-6 col-md-3 col-lg-3">
                    <article class="home-news-item">
                        <a href="">
                        <img src="img/portfolio/kubota_top3.jpg" alt="" class="img-responsive" />   
                        <div class="home-news-overlay blk-back">
                ...
                <div class="col-sm-6 col-md-3 col-lg-3">
                    <article class="home-news-item">            
                        <a href="">
                        <img src="img/portfolio/kubota_top4.jpg" alt="" class="img-responsive" />   
                        <div class="home-news-overlay blk-back">
