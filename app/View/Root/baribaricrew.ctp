    ...
    <div class="container">
        <div class="row"> 
            <div class="col-md-8 col-md-offset-2">
                <h1 class="artist-title2">Bari Bari Crew</h1>
        		<h2>久保田利伸オフィシャルファンクラブ</h2>
                <a href="/artist/kubota/login">
                <img src="img/portfolio/btn_bbc.jpg" class="img-responsive bottomthirty" alt="fanclub">
                </a>
                ...
                <table width=100% frame="box">
                    <tr>
                    <th class="shigemoto2">5000ポイント</th>
                    </tr>
                    <tr>
                    <td>
                        <div class="shigemoto3"><img src="img/portfolio/benefit08.jpg" alt="茂本ヒデキチ" />
                        </div>
                        <h3 class="shigemoto">茂本ヒデキチ画伯のイラスト画</h3>
